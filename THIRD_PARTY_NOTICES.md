...
제공자별 사용처·확인일·공식 약관 링크·공유 제한은 [데이터 출처와 공유 범위](docs/DATA_SOURCES.md)에 기록합니다. Catoshi의 소스·시각 자산 라이선스는 제3자 데이터의 가공·재배포·상업 이용 권한을 부여하지 않습니다.
...
Catoshi 고양이 아틀라스와 앱 아이콘은 Catoshi를 위해 제작·편집된 AI 보조 시각 자산입니다. 번들에 외부 스톡 이미지를 포함하지 않습니다. 소스·자산의 사용 범위는 [LICENSE](LICENSE)의 비상업적 개인 사용 조건을 따릅니다.

## macOS / SF Symbols

앱 UI는 Apple 플랫폼의 시스템 아이콘(SF Symbols)을 사용합니다. Catoshi는 Apple과 제휴하거나 Apple의 공식 제품이 아닙니다.
