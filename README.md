...
메뉴바의 작은 고양이와 함께 Binance·Upbit 가격, 시장 흐름, 국내 거래소 활동을 확인합니다. 소스를 내려받아 자신의 Mac에서 직접 빌드합니다. 사용 범위는 아래 라이선스 안내를 확인하세요.

> Catoshi is a source-available macOS menu-bar companion for Bitcoin and the Korean crypto market, licensed for non-commercial personal use only.
